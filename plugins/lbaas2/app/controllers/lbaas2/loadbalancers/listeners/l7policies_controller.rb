    ...
    module Listeners
      class L7policiesController < ::AjaxController
        ...
        def index
          ...
          l7policies =
            services.lbaas2.l7policies(
              { listener_id: params[:listener_id] }.merge(pagination_options),
            )
        ...
        def extend_l7policies_data(l7policies)
          l7policies.each do |l7policy|
            ...
            l7policy.cached_rules =
              ObjectCache
                .where(id: l7policy.rules.map { |l| l[:id] })
