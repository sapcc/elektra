  ...
  return ( 
    <HashRouter /*hashType="noslash"*/ >
      <div>
          ...
          <Route exact path="/loadbalancers/:loadbalancerID/json" component={LoadbalancerJSON}/>
          <Route exact path="/loadbalancers/:loadbalancerID/show/json" component={LoadbalancerJSON}/>
          <Route 
            path={[
          ...
          <Route exact path="/loadbalancers/:loadbalancerID/listeners/:listenerID/json" component={ListenerJSON}/>
          ...
          <Route exact path="/loadbalancers/:loadbalancerID/pools/:poolID/json" component={PoolJSON}/>
          ...
          <Route exact path="/loadbalancers/:loadbalancerID/pools/:poolID/healthmonitor/:healthmonitorID/json" component={HealthMonitorJSON}/>
          ...
          <Route exact path="/loadbalancers/:loadbalancerID/listeners/:listenerID/l7policies/:l7policyID/json" component={L7PolicyJSON}/>
          ...
          <Route exact path="/loadbalancers/:loadbalancerID/listeners/:listenerID/l7policies/:l7policyID/l7rules/:l7ruleID/json" component={L7RuleJSON}/>
      </div>
    </HashRouter>
   );
}
