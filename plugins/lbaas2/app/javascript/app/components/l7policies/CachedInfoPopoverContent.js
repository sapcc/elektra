...
const CachedInfoPopoverContent = ({props ,lbID ,listenerID ,l7PolicyID ,l7RuleIDs ,cachedl7RuleIDs}) => {
  const {displayInvert} = useL7Rule()
        ...
        <div key={id}>
          { cachedl7RuleIDs[id] ?
            <React.Fragment>
              ...
              <div className="row">
                <div className="col-md-12">
                  <b>Invert:</b> {displayInvert(cachedl7RuleIDs[id].payload.invert)}
                </div>
              </div>
              <div className="row">
                <div className="col-md-12">
              ...
              <div className="row">
                <div className="col-md-12">
                  <span className="display-flex">
                    <b>Value: </b>
                    <CopyPastePopover text={cachedl7RuleIDs[id].payload.value} size={20} shouldPopover={false} shouldCopy={false} bsClass="cp label-right"/>
                  </span>                  
                </div>
              </div>
            </React.Fragment>
