    ...
    <Modal
      ...
      bsClass="lbaas2 modal">
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-lg">Attach Floating IP</Modal.Title>
        </Modal.Header>
        ...
        <Form
          ...
          <Modal.Body>
            <p>Assign the floating IP to lbaas VIP so it could be accessed from external network.</p>
            <Form.Errors errors={formErrors}/>
            <Form.ElementHorizontal label='Floating IP' name="floating_ip" required>

              <SelectInput name="floating_ip" isLoading={floatingIPs.isLoading} items={floatingIPs.items} onChange={onSelectfloatingIPChange}/>
              { floatingIPs.error ? <span className='text-danger'>{floatingIPs.error}</span>:""}
