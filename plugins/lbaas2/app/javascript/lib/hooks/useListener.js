    ...
    switch (policy) {
        ...
        return {
          ...
          description: (
            <React.Fragment>
              ...
              <b>in text format.</b>
              <br />
              Format: PROXY TCP[VERSION] [REMOTE ADDR] [LOCAL ADDR] [REMOTE
              PORT] [LOCAL PORT] <br /> For more information please take a look
              at{" "}
              <a
      ...
      case "standard_tcp_a3de_v1_0":
        return {
          ...
          description: (
            <React.Fragment>
              Switch listener from FastL4 to standard profile on F5 device. Use
              it only when FastL4 profile doesn't work for your application!!!{" "}
              <a
      ...
      case "sso_22b0_v1_0":
        return {
          ...
          description: (
            <React.Fragment>
              Prompts clients for certificates. Validates Client Ceritificates
              and adds various X-SSL-Client-Cert-* attributes to HTTP header.
              Expects listener (TERMINATED_HTTPS) certificate name used for SSL
      ...
      case "http_redirect_a26c_v1_0":
        return {
          ...
          description: (
            <React.Fragment>
              Redirects all HTTP calls to HTTPS protocol on port 443. A given
              path will also be added to the https redirect, i.e.
