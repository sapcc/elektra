...
module KeyManager
  ...
  class Container < ::Core::ServiceLayer::Model
    module Type
      ...
      def self.to_hash
        {
          GENERIC.to_sym => 'Used for any type of container that a
                             user may wish to create.',
          CERTIFICATE.to_sym => 'Used for storing secrets: certificate,
                                 private_key (optional), private_key_passphrase
                                 (optional), intermediates (optional).',
          RSA.to_sym => 'Used for storing RSA public keys, private keys, and
      ...
      def self.realtion_to_type
        {
          ...
          Type::CERTIFICATE.to_sym => [CERTIFICATE, PRIVATE_KEY, PRIVATE_KEY_PASSPHRASE, INTERMEDIATES],
