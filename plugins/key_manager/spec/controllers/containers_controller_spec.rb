...
describe KeyManager::ContainersController, type: :controller do
  ...
  before :each do
    ...
    allow_any_instance_of(ServiceLayerNg::KeyManagerService).to receive(
      :secrets
  ...
  describe "GET 'create'" do
    ...
    it 'returns http success and redirects to index if validation is valid' do
      ...
      allow_any_instance_of(ServiceLayerNg::KeyManagerService).to receive(:new_container).and_return(mock_container)
