...
import AutoscalingConfigNg from "../../components/autoscaling/config_ng/list"
import {
...
export default connect(
  ...
  (dispatch) => ({
    deleteCastellumProjectResource: (...args) =>
      dispatch(deleteCastellumProjectResource(...args)),
    updateCastellumProjectResource: (...args) =>
      dispatch(updateCastellumProjectResource(...args)),
  })
)(AutoscalingConfigNg)
