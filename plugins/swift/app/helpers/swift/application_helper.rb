module Swift
  module ApplicationHelper
    ...
    def make_breadcrumb(container_name, path='')
      ...
      result = link_to(container_name, plugin('swift').list_objects_path(container_name))
      ...
      elements.each_with_index do |name,idx|
        link = plugin('swift').list_objects_path(container_name, path: elements[0..idx].join('/'))
