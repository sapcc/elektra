...
EditSecurityService = ({
  ...
  form className: 'form form-horizontal', onSubmit: handleSubmit,
    div className: 'modal-body',
      ...
      if securityService.status!='active'
        div null,
          # Type
...
shared_filesystem_storage.EditSecurityServiceModal = ReactModal.Wrapper('Edit SecurityService', EditSecurityService,
  large:true,
  closeButton: false,
  static: true
)
