((app) ->
  ...
  app.TOGGLE_SHARE_NETWORK_IS_NEW_STATUS = 'TOGGLE_SHARE_NETWORK_IS_NEW_STATUS'
  ############ SUBNETS #################
  ...
  app.SHARE_NETWORK_SECURITY_SERVICE_FORM_FAILURE         = 'SHARE_NETWORK_SECURITY_SERVICE_FORM_FAILURE'
