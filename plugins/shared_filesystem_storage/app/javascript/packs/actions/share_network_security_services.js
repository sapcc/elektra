...
const receiveShareNetworkSecurityService=(shareNetworkId,securityService)=>
  ({
...
const requestDeleteShareNetworkSecurityService=(shareNetworkId,securityServiceId) =>
  ({
...
const deleteShareNetworkSecurityServiceFailure=(shareNetworkId,securityServiceId) =>
  ({
...
const removeShareNetworkSecurityService=(shareNetworkId,securityServiceId) =>
  ({
...
const shouldFetchShareNetworkSecurityServices= function(state, shareNetworkId) {
  const shareNetworkSecurityServices = state.shared_filesystem_storage.shareNetworkSecurityServices[shareNetworkId];
