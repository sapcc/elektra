...
export default class SnapshotItem extends React.Component {
  ...
  render() {
    ...
    return (
      <tr
        className={snapshot.isFetching || snapshot.isDeleting ? "updating" : ""}
      >
        <td>
          ...
          {(policy.isAllowed("shared_filesystem_storage:snapshot_delete") ||
            ...
            <div className="btn-group">
              ...
              <ul className="dropdown-menu dropdown-menu-right" role="menu">
                {policy.isAllowed(
                  "shared_filesystem_storage:snapshot_delete"
                ) &&
                ...
                {policy.isAllowed(
                  "shared_filesystem_storage:snapshot_update"
                ) && (
                  <li>
                ...
                <li>
                  <Link to={`/snapshots/${snapshot.id}/error-log`}>
                    Error Log
                  </Link>
                </li>
              </ul>
