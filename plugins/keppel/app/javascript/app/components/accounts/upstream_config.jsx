...
export default class AccountUpstreamConfigModal extends React.Component {
  ...
  render() {
    ...
    if (!account || !account.replication || account.replication.strategy != 'from_external_on_first_use' || !isAdmin || !isEditable) {
      return null;
    }
        ...
        <Form
          ...
          <Modal.Body>
            <Form.ElementHorizontal label='Upstream source' name='url'>
              <Form.Input elementType='input' type='text' name='url' readOnly={true} />
