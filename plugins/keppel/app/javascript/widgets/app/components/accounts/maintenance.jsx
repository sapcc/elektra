      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-lg">
            {inMaintenance
              ? "End maintenance for account"
              : "Set account in maintenance"}
            : {account.name}
          </Modal.Title>
        </Modal.Header>
        ...
        >
          <Modal.Body>
            <p>
              This account {inMaintenance ? "has been" : "can be"} set{" "}
              <strong>in maintenance</strong> to prevent the pushing of new
              images into it. The account can only be deleted while it is in
              maintenance.
            </p>
          </Modal.Body>
          ...
          <Modal.Footer>
            <Form.SubmitButton
              label={inMaintenance ? "End maintenance" : "Set in maintenance"}
            />
