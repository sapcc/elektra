...
const columnDefs = [
  { key: 'service', label: 'Service type', sortStrategy: 'text',
    sortKey: props => props.error.service_type },
  { key: 'timestamp', label: 'Scrape failed at', sortStrategy: 'numeric',
    sortKey: props => props.error.checked_at || 0 },
  { key: 'project', label: 'Project', sortStrategy: 'text',
    sortKey: props => `${props.error.project.domain.name}/${props.error.project.name}` },
];
