...
export const castellum = (state, action) => {
  ...
  switch (action.type) {
    case constants.REQUEST_CASTELLUM_ERRORS:         return reqErrors(state, action);
    case constants.REQUEST_CASTELLUM_ERRORS_FAILURE: return reqErrorsFail(state, action);
    case constants.RECEIVE_CASTELLUM_ERRORS:         return recvErrors(state, action);
