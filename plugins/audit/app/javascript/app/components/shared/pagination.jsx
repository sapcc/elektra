...
export default ({
  ...
  let startPage = Math.max(1, Math.min(currentPage - padding, pages - paginationWindowSize + 1))
  ...
  let endPage   = Math.min(pages, Math.max(currentPage + padding, paginationWindowSize))
  ...
  let pageWindow = Array.from(new Array(endPage-startPage+1), (x,i) => startPage+i)
