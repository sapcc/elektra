...
describe ResourceManagement::ApplicationHelper, type: :helper do
  ...
  describe '#data_age_as_string' do
    it "stringifies data ages" do
      ...
      expect(data_age_as_string(50.seconds.ago)).to  eql("less than a minute ago")
    ...
    it "describes a set of timestamps with smallest and largest age" do
      ...
      expect(data_age_as_string(*timestamps)).to eql("between less than a minute and 30 minutes ago")
    end

    it "compresses common suffixes of age stringifications" do
      # e.g. it does not print "between 5 minutes and 3 minutes ago" here
      expect(data_age_as_string(5.minutes.ago, 3.minutes.ago)).to eql("between 3 and 5 minutes ago")
      expect(data_age_as_string(4.hours.ago, 11.hours.ago)).to eql("between 4 and 11 hours ago")
      expect(data_age_as_string(2.days.ago, 14.hours.ago)).to eql("between 1 and 2 days ago")
    end
  end
end
