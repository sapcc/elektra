module ResourceManagement
  ...
  class ResourceConfig
    attr_reader :name, :service_name, :data_type
    ...
    def self.all
      @all ||= [
        ...
        new(:shared_filesystem_storage, :share_networks),
        new(:shared_filesystem_storage, :shares),
        new(:shared_filesystem_storage, :share_snapshots),
        new(:shared_filesystem_storage, :share_capacity,              data_type: :bytes, data_sub_type: :giga),
        new(:shared_filesystem_storage, :snapshot_capacity,           data_type: :bytes, data_sub_type: :giga),
