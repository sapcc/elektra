  ...
  class ResourceConfig
    ...
    def self.all
      ...
      @all ||= [
        ...
        new(:networking,                :floating_ips,                pkg(false, 2)),
        new(:networking,                :networks,                    pkg(false, 1)),
        ...
        new(:block_storage,             :capacity,                    pkg(false, 16), data_type: :bytes, data_sub_type: :giga),
        new(:block_storage,             :snapshots,                   pkg(false, 2)),
        new(:block_storage,             :volumes,                     pkg(false, 2)),
        new(:object_storage,            :capacity,                    pkg(false, 256 << 30), data_type: :bytes),
