ResourceManagement::Engine.routes.draw do
  scope "/", as: "resources" do
    ...
    post "request" => "project_resources#create_request",
         :as => "create_request"
    ...
    get "request-package" => "project_resources#new_package_request",
        :as => "new_package_request"
    post "request-package/:package" =>
           "project_resources#create_package_request",
         :as => "create_package_request"
  ...
  scope "cloud_admin", as: "cloud_admin" do
    ...
    get "inconsistencies" => "cloud_admin#check_inconsistencies",
        :as => "inconsistencies"
  end
