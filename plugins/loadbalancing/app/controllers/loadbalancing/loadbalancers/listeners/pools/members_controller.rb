      ...
      module Pools
        class MembersController < DashboardController
          ...
          def add
            ...
            render 'loadbalancing/loadbalancers/listeners/pools/members/add_members.js'
          end
          ...
          def create
            ...
            if success
              redirect_to listener_show_details_path(listener_id), notice: 'Members successfully created.'
            else
              load_objects
              render action: :new
            end
          ...
          def destroy
            ...
            if services.loadbalancing.delete_pool_member(pool_id, member_id)
              ...
              redirect_to listener_show_details_path(listener_id), notice: 'Pool Member successfully deleted.'
            else
