...
export const domain = function (state, action) {
  ...
  switch (action.type) {
    case constants.REQUEST_DOMAIN:
      return requestDomain(state, action)
    case constants.REQUEST_DOMAIN_FAILURE:
      return requestDomainFailure(state, action)
    case constants.RECEIVE_DOMAIN:
      return receiveDomain(state, action)
    case constants.RESET_STORE:
      return resetDomain(state, action)
