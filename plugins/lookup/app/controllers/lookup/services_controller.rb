...
module Lookup
  class ServicesController < ApplicationController
    ...
    PROJECT_SERVICE_METHOD_MAP = {
      ...
      'volume' => %w[block_storage get_volume],
      'snapshot' => %w[block_storage get_snapshot],
      ...
      'inquiry' => %w[inquiry get_inquiry],
      'secret' => %w[key_manager secret],
      'container' => %w[key_manager container],
      ...
      'share_security_service' => %w[shared_filesystem_storage find_security_service]
    }.freeze
