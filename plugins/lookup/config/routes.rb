Lookup::Engine.routes.draw do
  ...
  match "/instances/:query" => "os_objects#show_instance",
        :as => :instances,
        :via => %i[get post]
  match "/projects/:query" => "os_objects#show_project",
        :as => :projects,
        :via => %i[get post]
  match "/networks/private/:query" => "os_objects#show_network_private",
        :as => :private_networks,
        :via => %i[get post]
  match "/networks/external/:query" => "os_objects#show_network_external",
        :as => :external_networks,
        :via => %i[get post]
