export const imageConstants = (type) => ({
  ...
  SET_ACTIVE_VISIBILITY: `image/os_images/${type}/SET_ACTIVE_VISIBILITY`,
})
...
export const REQUEST_IMAGE_MEMBERS_FAILURE =
  "image/image_members/REQUEST_IMAGE_MEMBERS_FAILURE"
...
export const REQUEST_DELETE_IMAGE_MEMBER =
  "image/image_members/REQUEST_DELETE_IMAGE_MEMBER"
export const DELETE_IMAGE_MEMBER_FAILURE =
  "image/image_members/DELETE_IMAGE_MEMBER_FAILURE"
