DnsService::Engine.routes.draw do
  get "request-zone-wizard" => "request_zone_wizard#new",
      :as => :new_zone_request
  post "request-zone-wizard" => "request_zone_wizard#create",
       :as => :create_zone_request
  ...
  resources :zones do
    scope module: :zones do
      ...
      collection do
        resources :transfer_requests, only: %i[index destroy] do
