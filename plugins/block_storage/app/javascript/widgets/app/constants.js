...
export const REQUEST_VOLUMES_FAILURE =
  "block_storage/app/REQUEST_VOLUME_FAILURE"
...
export const REQUEST_VOLUME_TYPES_FAILURE =
  "block_storage/app/REQUEST_VOLUME_TYPES_FAILURE"
...
export const REQUEST_AVAILABILITY_ZONES =
  "block_storage/app/REQUEST_AVAILABILITY_ZONES"
export const RECEIVE_AVAILABILITY_ZONES =
  "block_storage/app/RECEIVE_AVAILABILITY_ZONES"
export const REQUEST_AVAILABILITY_ZONES_FAILURE =
  "block_storage/app/REQUEST_AVAILABILITY_ZONE_FAILURE"
...
export const REQUEST_SNAPSHOTS_FAILURE =
  "block_storage/app/REQUEST_SNAPSHOT_FAILURE"
export const REQUEST_SNAPSHOT_DELETE =
  "block_storage/app/REQUEST_SNAPSHOT_DELETE"
export const RECEIVE_SNAPSHOT = "block_storage/app/RECEIVE_SNAPSHOT"
export const SET_SNAPSHOT_SEARCH_TERM =
  "block_storage/app/SET_SNAPSHOT_SEARCH_TERM"
...
export const REQUEST_SERVERS_FAILURE =
  "block_storage/app/REQUEST_SERVER_FAILURE"
...
export const VOLUME_STATE_RESERVED = "reserved"
...
export const VOLUME_PENDING_STATUS = [
  ...
  VOLUME_STATE_EXTENDING,
  VOLUME_STATE_RETYPING,
  VOLUME_STATE_UPLOADING,
  VOLUME_STATE_DOWNLOADING,
  VOLUME_STATE_AWAITING_TRANSFER,
  VOLUME_STATE_RESERVED,
  VOLUME_STATE_MAINTENANCE,
  VOLUME_STATE_BACKING_UP,
  VOLUME_STATE_RESTORING_BACKUP
]

export const VOLUME_RESET_STATUS = [VOLUME_STATE_AVAILABLE, VOLUME_STATE_ERROR]
...
export const SNAPSHOT_PENDING_STATUS = [
  ...
  SNAPSHOT_STATE_BACKING_UP,
  SNAPSHOT_STATE_BACKING_UP,
  SNAPSHOT_STATE_UNMANAGING,
