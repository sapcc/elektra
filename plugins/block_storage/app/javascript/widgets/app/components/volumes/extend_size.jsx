...
export default class ResetVolumeStatusForm extends React.Component {
  ...
  validate = (values) => {
    return values.size &&  this.props.volume && values.size > this.props.volume.size
  }
      ...
      <Modal
        ...
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-lg">
            Extend Volume Size <span className="info-text">{volume && volume.name || this.props.id}</span>
          </Modal.Title>
        </Modal.Header>
