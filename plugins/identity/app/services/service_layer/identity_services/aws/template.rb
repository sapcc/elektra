    ...
    module AWS
      ...
      module Template
        ...
        def templates(filter = {})
          response = elektron_identity.get('templates', filter)
          {
        ...
        def find_template!(uuid)
          elektron_identity.get("templates/#{uuid}").map_to(
            'body', &template_map
          )
        end
        ...
        def create_template(attributes = {})
          template_ref = elektron_identity.post('templates') do
            attributes
          end.body
        ...
        def delete_template(id)
          elektron_identity.delete("templates/#{id}")
        end
