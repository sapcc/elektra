...
describe 'Inquiry' do
  ...
  before(:each) do
    ...
    service_user = double('service_user',
                          identity: double('identity', id: '123', name: 'service_user_name', email: 'service_user_email', full_name: 'service_user_fullname').as_null_object)
  ...
  describe 'Inquiry' do
    context 'Create' do
      it 'creates a new Inquiry with initial status open' do
        ...
        expect do
          inq.save
        end.to change { Inquiry::Inquiry.count }.by(1)
