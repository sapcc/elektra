...
export const ports = function(state, action) {
  ...
  switch (action.type) {
    ...
    case constants.RECEIVE_PORTS: return receivePorts(state,action);
    case constants.REQUEST_PORTS: return requestPorts(state,action);
    case constants.REQUEST_PORTS_FAILURE: return requestPortsFailure(state,action);
    case constants.REQUEST_PORT: return requestPort(state,action);
    case constants.REQUEST_PORT_FAILURE: return requestPortFailure(state,action);
    case constants.RECEIVE_PORT: return receivePort(state,action);
    case constants.REQUEST_DELETE_PORT: return requestDeletePort(state,action);
    case constants.DELETE_PORT_FAILURE: return deletePortFailure(state,action);
    case constants.DELETE_PORT_SUCCESS: return deletePortSuccess(state,action);
