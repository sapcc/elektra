...
loadSampleToAddress=(event) ->
  value = event.target.value
  if value == "buzzmesam@gmail.com"
    $(emailToAddr).val "sirajudheenam@gmail.com"
    console.log "buzzmesam@gmail.com is loaded"
    console.log "sirajudheenam@gmail.com is populated"
