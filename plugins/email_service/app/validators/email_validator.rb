...
class EmailValidator < ActiveModel::EachValidator
  ...
  def validate_each(record, attribute, value)
    @parse_errors, @addresses, @valid_addresses, @invalid_addresses = validate_email_array(value)
    unless @parse_errors.empty?
      @parse_error_message = "PARSE ERROR: Invalid email address found. Please fix"
