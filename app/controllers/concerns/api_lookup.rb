module ApiLookup
  ...
  SERVICE_METHOD_MAP = {
    ...
    'loadbalancer' => ['lbaas2', 'find_loadbalancer(":term") ',
                       'loadbalancers(name: ":term")'],
    'lb_listener' => ['lbaas2', 'find_listener(":term")',
                      'listeners(name: ":term")'],
    'lb_pool' => ['lbaas2', 'find_pool(":term")',
                  'pools(name: ":term")'],
    'lb_healthmonitor' => ['lbaas2', 'find_healthmonitor(":term")',
