...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form_automation, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
    ...
    b.wrapper :input_area_wrapper, tag: 'div', class: 'col-sm-8' do |ba|
