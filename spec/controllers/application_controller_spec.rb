...
describe ApplicationController, type: :controller do
  controller do#SubControllersController do
    def index
      head :ok
    end
  end
  ...
  context "domain_id is provided, project_id is not provided" do
    ...
    describe "GET 'index'" do
      ...
      it "redirects to the same action with friendly ids for domain" do
        ...
        expect(response).to redirect_to(controller: "anonymous", action: "index", domain_id: @domain_friendly_id.slug)
      end
    end
  end
  ...
  context "domain_id and project_id are provided" do
    ...
    describe "GET 'index'" do
      ...
      it "redirects to the same action with friendly ids for domain and project" do
        ...
        expect(response).to redirect_to(controller: "anonymous", action: "index", domain_id: @domain_friendly_id.slug, project_id: @project_friendly_id.slug)
      end
    end
  end
