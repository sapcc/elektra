...
RSpec.describe Core::DataType do
  ...
  describe '#format' do
    ...
    it 'inserts spaces to group digits in large numbers' do
      ...
      expect(datatype_number.format(12345, false)).to     match(/^12345$/)
      expect(datatype_number.format(1234567, false)).to   match(/^1234567$/)
      expect(datatype_number.format(123456789, false)).to match(/^123456789$/)
    end
