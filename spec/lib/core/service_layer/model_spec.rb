...
describe Core::ServiceLayer::Model do
  ...
  describe 'attributes' do
    it 'should trim all attributes' do
      model = Core::ServiceLayer::Model.new(@service, 'a' => ' test a ', 'b' => '  test b  ')
      model.valid?
  ...
  describe 'update' do
    let(:model) {
      Core::ServiceLayer::Model.new(@service, 'id' => 1)
    }
  ...
  describe 'update' do
    it "calls driver's update method" do
      ...
      expect(@service).to receive(:update_model).with(1, a1: 'test1', a2: 'test2')
      @model.save
    end
  end
  ...
  describe 'attribute_to_object' do
    it 'creates an object from attributes' do
      ...
      subobject = @model.attribute_to_object(:subobject, Core::ServiceLayer::Model)
