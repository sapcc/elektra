...
class DefaultPluginGenerator
  ...
  def update_assets
    ...
    copy_file "default/app/assets/stylesheets/_application.scss",
              "#{plugin_path}/#{name}/app/assets/stylesheets/#{name}/_application.scss"
    copy_file "default/app/javascript/plugin.js",
              "#{plugin_path}/#{name}/app/javascript/plugin.js"
  end

  def modify_application_controller
    remove_file "#{plugin_path}/#{name}/app/controllers/#{name}/application_controller.rb"
    copy_file "default/app/controllers/application_controller.rb",
              "#{plugin_path}/#{name}/app/controllers/#{name}/application_controller.rb"
    copy_file "default/app/views/application/index.html.haml",
              "#{plugin_path}/#{name}/app/views/#{name}/application/index.html.haml"
  end

  def add_routes
    remove_file "#{plugin_path}/#{name}/config/routes.rb"
    copy_file "default/config/routes.rb",
